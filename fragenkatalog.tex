...
\usepackage{amsthm}
\usepackage{graphicx}
\author{Maximilian Kiefer-Emmanouilidis, Philipp Jaeger}
\title{Statistische Mechanik und Thermodynamik Eggert 2014}
\newtheorem{mydef}{Definition}
\newtheorem{myfrag}{Frage}
\newtheorem{mybem}{Bemerkung}
\newtheorem{mybei}{Beispiel}
\newtheorem{mybeh}{Behauptung}
\newtheorem{mybew}{Beweis}
\newtheorem{mycod}{Code}
\begin{document}
\maketitle
\tableofcontents
